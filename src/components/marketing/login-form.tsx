  ...
  return (
    <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-zinc-900">
      <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200">
        Welcome Back to Intera👋
      </h2>
      <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
        Login to your account to continue using Intera.
      </p>
      ...
      <form className="my-8 mb-4 flex flex-col w-full" onSubmit={handleSubmit}>
        ...
        <button
          ...
          disabled={isLoading}
        >
          {isLoading ? <>Loggin in...</> : <>Login &rarr;</>}
          <BottomGradient />
        </button>
